...
/** Model 1 — Trend structure (EMA 20/50) — used widely on your broker/TV style charts */
export function modelTrendStructure(bars: Bar[]): ModelResult {
  ...
  return {
    ...
    usedInApps: 'your broker · TradingView · most chart apps',
    signal,
...
export function modelRsi(bars: Bar[]): ModelResult {
  ...
  return {
    ...
    usedInApps: 'your broker · Upstox · TradingView · MetaTrader-style apps',
    signal,
