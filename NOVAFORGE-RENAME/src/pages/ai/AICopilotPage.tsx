...
function reply(q: string): string {
  ...
  return 'Novaforge view: setup looks constructive with supportive flows and selective sector strength (Banks/IT). Keep position sizing disciplined and use levels for adds/trims. Ask me about a specific ticker, sector, or risk question for a tighter read.\n\n(Demo AI — connect OpenAI key in production for live models.)'
}

export function AICopilotPage() {
  const [messages, setMessages] = useState<Msg[]>([
    { role: 'assistant', content: 'Hello. I am Novaforge AI Copilot. Ask about stocks, sectors, portfolio risk, or market structure.' },
  ])
