...
/** KD guide — clean symbol (no broken face art) */
  ...
  return (
    <div className={`${windowFrame} p-5 flex flex-col md:flex-row gap-5 items-center relative overflow-hidden`}>
      <div className="relative shrink-0 flex flex-col items-center">
        <div className="relative w-28 h-28 md:w-32 md:h-32 rounded-full bg-gradient-to-br from-amber-200 via-yellow-300 to-amber-500 border-4 border-white shadow-xl shadow-amber-200/80 flex items-center justify-center">
          ...
          <div className="text-center leading-none select-none">
            <div className="text-3xl md:text-4xl font-black text-slate-900 tracking-tighter">KD</div>
            <div className="text-[9px] font-bold text-slate-700 uppercase tracking-widest mt-1">Agent</div>
          </div>
        </div>
        <div className="mt-2 px-3 py-0.5 rounded-full bg-slate-900 text-amber-300 text-[9px] font-black uppercase tracking-wider">
          Levels only
        </div>
      </div>
      <div className="flex-1 text-center md:text-left space-y-1">
        <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-amber-700">Guide</div>
