...
export const IDEAS: Record<string, IdeaStock[]> = {
  seasonal: [
    { symbol: 'ITC', name: 'ITC Ltd', sector: 'Consumer', price: 465, changePercent: 0.4, why: 'Often firmer in festive/consumption periods historically.', risk: 'Policy & cigarette regulation headlines.', hint: 'On your broker/your broker: size small; avoid adding right before major policy events.' },
  ...
  '52w-low': [
    ...
    { symbol: 'HINDALCO', name: 'Hindalco', sector: 'Metals', price: 580, changePercent: -0.6, why: 'Mean-reversion watch when metals sentiment is weak.', risk: 'Global aluminium/copper prices.', hint: 'Pair with global metal trend; keep position size modest on your broker.' },
  ...
  cheap: [
    { symbol: 'VEDL', name: 'Vedanta', sector: 'Metals', price: 410, changePercent: -0.4, why: 'Often below sector average multiples in soft commodity phases.', risk: 'Debt, commodity, regulatory.', hint: 'High risk — treat as speculative watch only on your broker/your broker.' },
  ...
  growth: [
    ...
    { symbol: 'DIXON', name: 'Dixon Technologies', sector: 'Electronics', price: 12800, changePercent: 0.9, why: 'EMS / electronics manufacturing growth theme.', risk: 'High beta, sharp drawdowns.', hint: 'Volatile — defined risk only if trading derivatives on your broker.' },
  ],
  momentum: [
  ...
  future: [
    { symbol: 'HAL', name: 'Hindustan Aeronautics', sector: 'Defence', theme: 'Defence & Space', price: 4200, changePercent: 0.7, why: 'Defence manufacturing & order-book theme.', risk: 'Order delays, valuation.', hint: 'Theme idea for your broker watchlist; avoid oversized options into budget defence noise.' },
    ...
    { symbol: 'TATAPOWER', name: 'Tata Power', sector: 'Energy', theme: 'Green Energy', price: 390, changePercent: 0.4, why: 'Renewables + power transition theme.', risk: 'Execution and rate environment.', hint: 'Green theme list for your broker; check debt and project updates.' },
    { symbol: 'POLICYBZR', name: 'PB Fintech', sector: 'Financials', theme: 'AI & Digital', price: 1450, changePercent: -0.8, why: 'Digital insurance / fintech platform narrative.', risk: 'Path to profit and competition.', hint: 'Digital theme — treat as high volatility on your broker.' },
  ],
  event: [
    ...
    { symbol: 'TCS', name: 'TCS', sector: 'Technology', price: 4120, changePercent: 0.5, why: 'IT heavyweight; reacts to US demand and INR narratives.', risk: 'Global IT spend.', hint: 'Into US macro prints, keep size controlled on your broker options.' },
  ],
}
...
export const EXPIRY_STATS = {
  ...
  hint: 'For your broker/your broker: into expiry, prefer defined risk; avoid oversized overnight shorts/longs if VIX is spiked.',
}
...
export const BUDGET_STATS = {
  ...
  hint: 'Cut position size before Budget day; wait for document clarity before aggressive options on your broker/your broker.',
}
  ...
  return [
    {
      ...
      body: 'If this is an expiry week, expect faster swings. Keep quantity smaller on your broker/your broker.',
    ...
    },
    {
      ...
      body: 'Novaforge lists are research hints only. Execution stays on your broker.',
